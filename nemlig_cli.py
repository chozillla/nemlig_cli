...
"""
UgeMad - A command-line interface for nemlig.com grocery shopping.
...
def cmd_list_recipes(auth: "AuthTokens", args: argparse.Namespace) -> int:
    ...
    if not items:
        print("Your grocery list is empty. Add items first with `just list-add`.")
        return 1
